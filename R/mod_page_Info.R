      ...
      bslib::nav_panel("Overview", value = "dash",
            ...
            h5(strong(style="color:#005398","Dashboard overview")),
             ...
             p("This dashboard enables independent exploration of a spatially
               ...
               selected set of key life domains and variables."),
            ...
            data used."),
             ...
             h5(strong(style="color:#005398","Usage")),
             ...
             and access further resources available for independent use:"),

            tags$ul(
              tags$li(a("SIPHER Synthetic Population dataset - UK Data Service",
            ...
            h5(strong(style="color:#005398","Contact us")),
             ...
             Population - Dashboard' to ",
               a("sipher@glasgow.ac.uk", href="mailto:sipher@glasgow.ac.uk"))

                         )
                       )
                       ),

      bslib::nav_panel("Synthetic Population dataset", value= "background",
        ...
        fluidRow(
          ...
          mainPanel(
            ...
            p("The SIPHER Synthetic Population dataset is also available for full
            independent use:"),
            tags$ul(
              tags$li(a("SIPHER Synthetic Population dataset - UK Data Service",
                        href="https://beta.ukdataservice.ac.uk/datacatalogue/studies/study?id=9277",
            ...
            p("Further information and resources about the SIPHER Synthetic Population dataset:"),
            tags$ul(
              tags$li(a("Synthetic Population product page - SIPHER Consortium website",
      ...
      bslib::nav_panel("Usage and interpretation", value = "SyntheticPopNotes",
            ...
            fluidRow(
              ...
              mainPanel(
                ...
                tags$ul(
                  tags$li( a("SIPHER Synthetic Population Dashboard - Github Repository",
